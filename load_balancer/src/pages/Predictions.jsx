  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <MetricCard label="Current Load" value={formatDecimal(predictions.currentLoad)} unit="%" color="indigo" />
        <MetricCard label="Predicted Load" value={formatDecimal(predictions.predictedLoad)} unit="%" color="cyan" />
        <MetricCard label="Confidence" value={formatDecimal(predictions.confidence)} unit="%" color="emerald" />
        <MetricCard label="Rate of Change" value={formatDecimal(predictions.rateOfChange)} color={predictions.rateOfChange > 0.3 ? 'red' : 'amber'} />
      </div>
      ...
      <div className="bg-gray-900/70 border border-gray-800 rounded-xl p-5">
        <div className="flex items-center justify-between mb-4">
          <div>
            <h2 className="text-base font-semibold text-white">Actual vs Predicted Composite Load</h2>
